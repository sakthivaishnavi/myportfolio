...
const Contact = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center gap-1 md:gap-12 p-6">
      <div className="flex items-center gap-3 md:gap-4 hover:border-b-2 hover:border-[#5eead4] p-3 rounded-xl text-[#5eead4] hover:text-white transition ease-in-out duration-500 hover:scale-110">
