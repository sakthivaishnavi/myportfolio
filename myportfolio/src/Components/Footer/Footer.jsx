...
const Footer = () => {
  ...
  return (
    <div className='flex justify-center items-center border border-l-0 border-r-0 border-b-0 border-t-2 p-6 border-t-[#272c2a] mt-8 h-12 text-[#5eead4] text-sm lg:text-lg gap-2'>
