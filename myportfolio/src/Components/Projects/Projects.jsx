        ...
        <Slide key={inView ? 'inView' : 'notInView'} left={true} duration={2500} distance={'100px'}>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ml-20 mr-20 mt-16'>
            <div className='text-wrap bg-gray-950 hover:bg-gray-900 hover:text-[#5eead4] hover:shadow-[#5eead4] hover:shadow-md p-5 rounded-3xl hover:scale-95 transition-all duration-300 ease-in-out'>
              ...
              <div className='flex gap-4 mt-4 justify-center items-center'>
                <div className='bg-gray-800 hover:bg-[#5eead4] hover:text-gray-950 p-2 rounded-xl mt-4 w-36 flex gap-2 justify-center items-center'>
                  <div>
                    <a href='https://picky-recipe-finder.vercel.app/' target='_blank' rel='noreferrer'>Check it out</a>
                  </div>
                  <div> <FaArrowCircleRight /></div>
                </div>
                <div className='hover:bg-gray-950 hover:text-gray-950 p-1 rounded-full mt-4'>
                <a href='https://github.com/sakthivaishnavi/Recipe-Finder'>
            ...
            <div className='text-wrap bg-gray-950 hover:bg-gray-900 hover:text-[#5eead4] hover:shadow-[#5eead4] hover:shadow-md p-5 rounded-3xl hover:scale-95 transition-all duration-300 ease-in-out'>
              ...
              <div className='flex gap-4 mt-4 justify-center items-center'>
                ...
                <div className='hover:bg-gray-950 hover:text-gray-950 p-1 rounded-full mt-4'>
                <a href='https://github.com/sakthivaishnavi/FC-APP'>
                 <FaGithub className="text-[#5eead4] text-4xl cursor-pointer w-7" /></a>
                </div>
              </div>
            </div>
            ...
            <div className='text-wrap bg-gray-950 hover:bg-gray-900 hover:text-[#5eead4] hover:shadow-[#5eead4] hover:shadow-md p-5 rounded-3xl hover:scale-95 transition-all duration-300 ease-in-out'>
              ...
              <div className='flex gap-4 mt-4 justify-center items-center'>
                ...
                <div className='hover:bg-gray-950 hover:text-gray-950 p-1 rounded-full mt-4'>
                <a href='https://github.com/sakthivaishnavi/Vehicle-Monitoring-App'>
                 <FaGithub className="text-[#5eead4] text-4xl cursor-pointer w-7" /></a>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-center items-center">
            <div className='flex justify-center items-center ml-72 mr-72 mt-8 gap-8 '>
              <div className='text-wrap w-3/4 bg-gray-950 hover:bg-gray-900 hover:text-[#5eead4] hover:shadow-[#5eead4] hover:shadow-md p-5 rounded-3xl hover:scale-95 transition-all duration-300 ease-in-out'>
                ...
                <div className='flex gap-4 mt-4 justify-center items-center'>
                  <div className='text-center bg-gray-800 p-1 rounded-xl w-24 text-[#2dc1ab]'>
                    <p>React.js</p>
                  </div>
                ...
                <div className='bg-gray-800 hover:bg-[#5eead4] hover:text-gray-950 p-2 rounded-xl mt-4 w-36 flex gap-2 justify-center items-center'>
                  ...
                  <div className='hover:bg-gray-950 hover:text-gray-950 p-1 rounded-full mt-4'>
                <a href='https://github.com/sakthivaishnavi/myportfolio'>
                 <FaGithub className="text-[#5eead4] text-4xl cursor-pointer w-7" /></a>
                </div>
                </div>
              </div>
              ...
              <div className='text-wrap w-3/4 bg-gray-950 hover:bg-gray-900 hover:text-[#5eead4] hover:shadow-[#5eead4] hover:shadow-md p-5 rounded-3xl hover:scale-95 transition-all duration-300 ease-in-out'>
                ...
                <p className='mt-4 text-wrap text-justify'>
                  ...
                  selecting an emoji. The admin can view, update, and delete these messages.
                ...
                <div className='bg-gray-800 hover:bg-[#5eead4] hover:text-gray-950 p-2 rounded-xl mt-4 w-36 flex gap-2 justify-center items-center'>
                  ...
                  <div className='hover:bg-gray-950 hover:text-gray-950 p-1 rounded-full mt-4'>
                <a href='https://github.com/sakthivaishnavi/Anonymous_feedback_app'>
                 <FaGithub className="text-[#5eead4] text-4xl cursor-pointer w-7" /></a>
                </div>
                </div>
              </div>
